...
description: Continuing on with my habit of building websites for fake companies, how could I not do Dunder Mifflin?
demo: https://iamjohnoconnell.github.io/Dunder-Mifflin/
repo: https://github.com/IAmJohnOconnell/Dunder-Mifflin
thumb: ../images/thumbs/dundermifflin.png
steppingstone: true
---
...
Continuing on with my habit of building websites for fake companies, how could I not do Dunder Mifflin?

| Stack | Repo                                                            | Demo                                                              |
| ----- | --------------------------------------------------------------- | ----------------------------------------------------------------- |
| HTML  | [Repository](https://github.com/IAmJohnOconnell/Dunder-Mifflin) | [Check it Out](https://iamjohnoconnell.github.io/Dunder-Mifflin/) |
| CSS   |                                                                 |                                                                   |
| JS    |                                                                 |                                                                   |
